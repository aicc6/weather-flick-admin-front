        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {format(new Date(contact.created_at), 'yyyy년 MM월 dd일 HH:mm', {
                  locale: ko,
                })}
              </span>
            </div>
          ...
          {contact.answer && !isEditing ? (
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
                ...
                <span>
                  작성일:{' '}
                  {format(new Date(contact.answer.created_at), 'yyyy.MM.dd HH:mm', {
                    locale: ko,
                  })}
                </span>
                {contact.answer.updated_at !== contact.answer.created_at && (
                  <>
                    ...
                    <span>
                      수정일:{' '}
                      {format(new Date(contact.answer.updated_at), 'yyyy.MM.dd HH:mm', {
                        locale: ko,
                      })}
                    </span>
                  </>
